...
NORMAL_URL = f"https://portal.ez.na.rme.logistics.a2z.com/work-orders?organizationId=GYR1&customPreset=allOpen&preset=allOpen&primaryOwner={OWNER}&pmComplianceMaxDate=customDateRange,{TODAY},{TODAY}&primaryOwnerSort=asc,1&pmComplianceMaxDateSort=asc,2"
