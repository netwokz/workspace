...
def get_data_json():
    URL = (
        f"https://mobi.aps.com/MeterServices/v1/getbillingreadusage?account-id=5430550000&start-date=2024/Mar/21&end-date=2024/Mar/22&delivered-or-received-flag=D&badge-number=DG2864&SDPId=2281015339"
    )
